...
## 整个界面中使用的强调色，用于标记和突出显示文本。（革命红）
define gui.accent_color = '#C41E3A'
...
## 标题菜单和游戏菜单使用的图像。
define gui.main_menu_background = "cycling_main_menu_bg"
...
## 红色革命主题 — 人物对话与姓名（样式互不相同）
##
## 姓名：金黄标语色 + 深红描边，醒目如革命旗帜标题。
define gui.name_text_color = '#FFD700'
define gui.name_text_outlines = [(3, '#8B0000', 0, 0), (1, '#4A0000', 1, 1)]

## 对话：米白文书色 + 暗红细描边，庄重可读如历史文献正文。
define gui.dialogue_text_color = '#FFF5E6'
define gui.dialogue_text_outlines = [(2, '#6B1A1A', 0, 0)]
